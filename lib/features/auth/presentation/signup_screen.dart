...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp(AuthController authController) async {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AuthTextField(
                      ...
                      validator: (v) =>
                          Validators.validateNotEmpty(v, fieldName: "First Name"),
                    ),
                    ...
                    AuthTextField(
                      ...
                      validator: (v) =>
                          Validators.validateNotEmpty(v, fieldName: "Last Name"),
                    ),
                    const SizedBox(height: 16),
                    AuthTextField(
                      hintText: "Email",
